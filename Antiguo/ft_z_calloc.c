...
/*   Updated: 2025/10/21 12:37:21 by jesolano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/* ---------- ft_calloc.c ---------- */
/* Allocates memory for an array of nmemb elements of size bytes each and initializes all bytes to zero. Returns pointer to allocated memory or NULL if allocation fails. */
